...
object ActorsPaths {
  ...
  def QUERY_NAME_ACTOR_NAME = "QueryName"
  def QUERY_NAME_ACTOR_PATH = s"$LOCAL_SUPERVISOR_ACTOR_PATH/$QUERY_NAME_ACTOR_NAME"
  ...
  def HIVE_ACTOR_NAME = "Hive"
  def HIVE_ACTOR_PATH = s"$LOCAL_SUPERVISOR_ACTOR_PATH/$HIVE_ACTOR_NAME"
}
